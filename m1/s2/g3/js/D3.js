...
/* ESERCIZIO 4
  Crea un oggetto "eyeColor" che abbia le seguenti proprietà: blue, yellow, brown, red, blue-grey.
...
let randomIndex = Math.floor(Math.random() * starWarsCharacters.length) +  1
let selectedCharacter = starWarsCharacters[randomIndex]

if (selectedCharacter.gender === "female") {
  console.log("Il personaggio selezionato e' " + starWarsCharacters[randomIndex].name + ". Lei e' alta " + selectedCharacter.height + " cm");
} else {
  console.log("Il personaggio selezionato e' " + starWarsCharacters[randomIndex].name + ". Lui e' alto " + selectedCharacter.height + " cm");
}
